<?php namespace Ideaseven\SendGrid;
...
class Plugin extends PluginBase
{
    ...
    {
        return [
            'name'        => 'ideaseven.sendgrid::lang.plugin_name',
            'description' => 'ideaseven.sendgrid::lang.plugin_description',
        ...
        Event::listen('backend.form.extendFields', function ($widget) {
            ...
            $widget->addTabFields([
                'sendgrid_api_key' => [
                    ...
                    'label'   => 'ideaseven.sendgrid::lang.sendgrid_api_key',
                    'type'    => 'sensitive',
                    'commentAbove' => 'ideaseven.sendgrid::lang.sendgrid_api_key_comment',
                    'trigger' => [
                        'action'    => 'show',
                        'field'     => 'send_mode',
